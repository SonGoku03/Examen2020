...
import com.emontec.examen.Adapter.MyAppAdapter;
import com.emontec.examen.Librerias.HttpRequest;
import com.emontec.examen.MyAppModel;
        ...
        switch (serviceCode) {
            ...
            case codigodatos:
                ...
                if (siCorrecto(response)) {
                    ...
                    Toast.makeText(Json.this, obtenerCodigoError(response), Toast.LENGTH_SHORT).show();
                }
        }
    }
